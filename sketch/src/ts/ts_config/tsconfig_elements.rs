...
impl Display for WatchFile {
	fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			Self::UseFsEvents => write!(f, "useFsEvents"),
			Self::UseFsEventsOnParentDirectory => write!(f, "useFsEventsOnParentDirectory"),
			Self::FixedChunkSizePolling => write!(f, "fixedChunkSizePolling"),
		}
	}
}
...
impl Display for Jsx {
	fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			Self::ReactJsx => write!(f, "react-jsx"),
			Self::ReactJsxdev => write!(f, "react-jsxdev"),
...
impl Display for Lib {
	fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
		match self {
			...
			Self::WebWorker => write!(f, "WebWorker"),
			Self::ScriptHost => write!(f, "ScriptHost"),
		}
	}
}
