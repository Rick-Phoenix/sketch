...
impl PnpmPreset {
  pub fn process_data(
    ...
    let merged_preset = merge_presets(Preset::PnpmWorkspace, id, self, store, &mut processed_ids)?;
...
pub struct PnpmWorkspace {
  ...
  /// A list of dependencies that are patched. See more: https://pnpm.io/settings#patcheddependencies
  #[serde(alias = "patched_dependencies")]
  #[serde(skip_serializing_if = "Option::is_none")]
  #[merge(strategy = merge_optional_btree_maps)]
  pub patched_dependencies: Option<StringBTreeMap>,

  /// When true, installation won't fail if some of the patches from the `patchedDependencies` field were not applied. Previously named `allowNonAppliedPatches`. See more: https://pnpm.io/settings#allowunusedpatches
  ...
  /// A list of optional dependencies that the install should be skipped. See more: https://pnpm.io/settings#ignoredoptionaldependencies
  ...
  /// When true, all dependencies are hoisted to node_modules/.pnpm/node_modules. See more: https://pnpm.io/settings#hoist
  #[serde(alias = "hoist")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub hoist: Option<bool>,

  /// When true, packages from the workspaces are symlinked to either <workspace_root>/node_modules/.pnpm/node_modules or to <workspace_root>/node_modules depending on other hoisting settings (hoistPattern and publicHoistPattern). See more: https://pnpm.io/settings#hoistworkspacepackages
  #[serde(alias = "hoist_workspace_packages")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub hoist_workspace_packages: Option<bool>,

  /// Tells pnpm which packages should be hoisted to node_modules/.pnpm/node_modules. See more: https://pnpm.io/settings#hoistpattern
  #[serde(alias = "hoist_pattern")]
  #[serde(skip_serializing_if = "Option::is_none")]
  #[merge(strategy = merge_optional_btree_sets)]
  pub hoist_pattern: Option<BTreeSet<String>>,

  /// Unlike hoistPattern, which hoists dependencies to a hidden modules directory inside the virtual store, publicHoistPattern hoists dependencies matching the pattern to the root modules directory. See more: https://pnpm.io/settings#publichoistpattern
  #[serde(alias = "public_hoist_pattern")]
  #[serde(skip_serializing_if = "Option::is_none")]
  #[merge(strategy = merge_optional_btree_sets)]
  pub public_hoist_pattern: Option<BTreeSet<String>>,

  /// By default, pnpm creates a semistrict node_modules, meaning dependencies have access to undeclared dependencies but modules outside of node_modules do not. See more: https://pnpm.io/settings#shamefullyhoist
  ...
  /// When symlink is set to false, pnpm creates a virtual store directory without any symlinks. It is a useful setting together with nodeLinker=pnp. See more: https://pnpm.io/settings#symlink
  #[serde(skip_serializing_if = "Option::is_none")]
  pub symlink: Option<bool>,

  /// When false, pnpm will not write any files to the modules directory (node_modules). See more: https://pnpm.io/settings#enablemodulesdir
  ...
  /// The time in minutes after which orphan packages from the modules directory should be removed. See more: https://pnpm.io/settings#modulescachemaxage
  #[serde(alias = "modules_cache_max_age")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub modules_cache_max_age: Option<usize>,

  /// The time in minutes after which dlx cache expires. See more: https://pnpm.io/settings#dlxcachemaxage
  ...
  /// Some registries allow the exact same content to be published under different package names and/or versions. See more: https://pnpm.io/settings#strictstorepkgcontentcheck
  #[serde(alias = "strict_store_pkg_content_check")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub strict_store_pkg_content_check: Option<bool>,

  /// When enabled, node_modules contains only symlinks to a central virtual store, rather than to node_modules/.pnpm. See more: https://pnpm.io/settings#enableglobalvirtualstore
  #[serde(alias = "enable_global_virtual_store")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub enable_global_virtual_store: Option<bool>,

  /// When set to false, pnpm won't read or generate a pnpm-lock.yaml file. See more: https://pnpm.io/settings#lockfile
  #[serde(alias = "lockfile")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub lockfile: Option<bool>,

  /// When set to true and the available pnpm-lock.yaml satisfies the package.json dependencies directive, a headless installation is performed. See more: https://pnpm.io/settings#preferfrozenlockfile
  #[serde(alias = "prefer_frozen_lockfile")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub prefer_frozen_lockfile: Option<bool>,

  /// Add the full URL to the package's tarball to every entry in pnpm-lock.yaml. See more: https://pnpm.io/settings#lockfileincludetarballurl
  #[serde(alias = "lockfile_include_tarball_url")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub lockfile_include_tarball_url: Option<bool>,

  /// When set to true, the generated lockfile name after installation will be named based on the current branch name to completely avoid merge conflicts. See more: https://pnpm.io/settings#gitbranchlockfile
  #[serde(alias = "git_branch_lockfile")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub git_branch_lockfile: Option<bool>,

  /// This configuration matches the current branch name to determine whether to merge all git branch lockfile files. See more: https://pnpm.io/settings#mergegitbranchlockfilesbranchpattern
  ...
  /// Max length of the peer IDs suffix added to dependency keys in the lockfile. If the suffix is longer, it is replaced with a hash. See more: https://pnpm.io/settings#peerssuffixmaxlength
  #[serde(alias = "peers_suffix_max_length")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub peers_suffix_max_length: Option<usize>,

  /// The base URL of the npm package registry (trailing slash included). See more: https://pnpm.io/settings#registry
  #[serde(skip_serializing_if = "Option::is_none")]
  pub registry: Option<String>,

  /// The Certificate Authority signing certificate that is trusted for SSL connections to the registry. See more: https://pnpm.io/settings#ca
  #[serde(skip_serializing_if = "Option::is_none")]
  ...
  /// A client key to pass when accessing the registry. See more: https://pnpm.io/settings#key
  #[serde(skip_serializing_if = "Option::is_none")]
  pub key: Option<String>,

  /// When fetching dependencies that are Git repositories, if the host is listed in this setting, pnpm will use shallow cloning to fetch only the needed commit, not all the history. See more: https://pnpm.io/settings#gitshallowhosts
  #[serde(alias = "git_shallow_hosts")]
  #[serde(skip_serializing_if = "Option::is_none")]
  #[merge(strategy = merge_optional_btree_sets)]
  pub git_shallow_hosts: Option<BTreeSet<String>>,

  /// A proxy to use for outgoing HTTPS requests. If the HTTPS_PROXY, https_proxy, HTTP_PROXY or http_proxy environment variables are set, their values will be used instead. See more: https://pnpm.io/settings#https-proxy
  #[serde(alias = "https_proxy")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub https_proxy: Option<String>,

  /// A proxy to use for outgoing http requests. If the HTTP_PROXY or http_proxy environment variables are set, proxy settings will be honored by the underlying request library. See more: https://pnpm.io/settings#proxy
  #[serde(skip_serializing_if = "Option::is_none")]
  pub proxy: Option<String>,

  /// The IP address of the local interface to use when making connections to the npm registry. See more: https://pnpm.io/settings#local-address
  #[serde(alias = "local_address")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub local_address: Option<String>,

  /// The maximum number of connections to use per origin (protocol/host/port combination). See more: https://pnpm.io/settings#maxsockets
  #[serde(rename = "maxsockets", alias = "max_sockets")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub max_sockets: Option<usize>,

  /// A comma-separated string of domain extensions that a proxy should not be used for. See more: https://pnpm.io/settings#noproxy
  #[serde(rename = "noproxy", alias = "no_proxy")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub no_proxy: Option<String>,

  /// Whether or not to do SSL key validation when making requests to the registry via HTTPS. See more: https://pnpm.io/settings#strict-ssl
  #[serde(alias = "strict_ssl")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub strict_ssl: Option<bool>,

  /// Controls the maximum number of HTTP(S) requests to process simultaneously. See more: https://pnpm.io/settings#networkconcurrency
  #[serde(alias = "network_concurrency")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub network_concurrency: Option<usize>,

  /// How many times to retry if pnpm fails to fetch from the registry. See more: https://pnpm.io/settings#fetchretries
  #[serde(alias = "fetch_retries")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub fetch_retries: Option<usize>,

  /// The exponential factor for retry backoff. See more: https://pnpm.io/settings#fetchretryfactor
  #[serde(alias = "fetch_retry_factor")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub fetch_retry_factor: Option<usize>,

  /// The minimum (base) timeout for retrying requests. See more: https://pnpm.io/settings#fetchretrymintimeout
  #[serde(alias = "fetch_retry_min_timeout")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub fetch_retry_min_timeout: Option<usize>,

  /// The maximum fallback timeout to ensure the retry factor does not make requests too long. See more: https://pnpm.io/settings#fetchretrymaxtimeout
  #[serde(alias = "fetch_retry_max_timeout")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub fetch_retry_max_timeout: Option<usize>,

  /// The maximum amount of time to wait for HTTP requests to complete. See more: https://pnpm.io/settings#fetchtimeout
  #[serde(alias = "fetch_timeout")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub fetch_timeout: Option<usize>,

  /// When true, any missing non-optional peer dependencies are automatically installed. See more: https://pnpm.io/settings#autoinstallpeers
  #[serde(alias = "auto_install_peers")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub auto_install_peers: Option<bool>,

  /// When this setting is set to true, packages with peer dependencies will be deduplicated after peers resolution. See more: https://pnpm.io/settings#dedupepeerdependents
  ...
  /// When enabled, dependencies of the root workspace project are used to resolve peer dependencies of any projects in the workspace. See more: https://pnpm.io/settings#resolvepeersfromworkspaceroot
  ...
  /// Experimental option that enables beta features of the CLI. See more: https://pnpm.io/settings#usebetacli
  #[serde(alias = "use_beta_cli")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub use_beta_cli: Option<bool>,

  /// If this is enabled, the primary behaviour of pnpm install becomes that of pnpm install -r, meaning the install is performed on all workspace or subdirectory packages. See more: https://pnpm.io/settings#recursiveinstall
  #[serde(alias = "recursive_install")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub recursive_install: Option<bool>,

  /// If this is enabled, pnpm will not install any package that claims to not be compatible with the current Node version. See more: https://pnpm.io/settings#enginestrict
  ...
  /// When enabled, pnpm will fail if its version doesn't exactly match the version specified in the packageManager field of package.json. See more: https://pnpm.io/settings#packagemanagerstrictversion
  #[serde(alias = "package_manager_strict_version")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub package_manager_strict_version: Option<bool>,

  /// When enabled, pnpm will automatically download and run the version of pnpm specified in the packageManager field of package.json. See more: https://pnpm.io/settings#managepackagemanagerversions
  #[serde(alias = "manage_package_manager_versions")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub manage_package_manager_versions: Option<bool>,

  /// Do not execute any scripts defined in the project package.json and its dependencies. See more: https://pnpm.io/settings#ignorescripts
  #[serde(alias = "ignore_scripts")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub ignore_scripts: Option<bool>,

  /// Do not execute any scripts of the installed packages. Scripts of the projects are executed. See more: https://pnpm.io/settings#ignoredepscripts
  #[serde(alias = "ignore_dep_scripts")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub ignore_dep_scripts: Option<bool>,

  /// The maximum number of child processes to allocate simultaneously to build node_modules. See more: https://pnpm.io/settings#childconcurrency
  #[serde(alias = "child_concurrency")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub child_concurrency: Option<usize>,

  /// Use and cache the results of (pre/post)install hooks. See more: https://pnpm.io/settings#sideeffectscache
  #[serde(alias = "size_effects_cache")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub size_effects_cache: Option<bool>,

  /// Only use the side effects cache if present, do not create it for new packages. See more: https://pnpm.io/settings#sideeffectscachereadonly
  #[serde(alias = "size_effects_cache_read_only")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub size_effects_cache_read_only: Option<bool>,

  /// Set to true to enable UID/GID switching when running package scripts. If set explicitly to false, then installing as a non-root user will fail. See more: https://pnpm.io/settings#unsafeperm
  #[serde(alias = "unsafe_perm")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub unsafe_perm: Option<bool>,

  /// Options to pass through to Node.js via the NODE_OPTIONS environment variable. See more: https://pnpm.io/settings#nodeoptions
  ...
  /// When strictDepBuilds is enabled, the installation will exit with a non-zero exit code if any dependencies have unreviewed build scripts (aka postinstall scripts). See more: https://pnpm.io/settings#strictdepbuilds
  #[serde(alias = "strict_dep_builds")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub strict_dep_builds: Option<bool>,

  /// Specifies which exact Node.js version should be used for the project's runtime. See more: https://pnpm.io/settings#usenodeversion
  #[serde(alias = "use_node_version")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub use_node_version: Option<String>,

  /// The Node.js version to use when checking a package's engines setting. See more: https://pnpm.io/settings#nodeversion
  ...
  /// Enables hard-linking of all local workspace dependencies instead of symlinking them. See more: https://pnpm.io/settings#injectworkspacepackages
  #[serde(alias = "inject_workspace_packages")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub inject_workspace_packages: Option<bool>,

  /// Injected workspace dependencies are collections of hardlinks, which don't add or remove the files when their sources change. See more: https://pnpm.io/settings#syncinjecteddepsafterscripts
  #[serde(alias = "sync_injected_deps_after_scripts")]
  #[serde(skip_serializing_if = "Option::is_none")]
  #[merge(strategy = merge_optional_btree_sets)]
  pub sync_injected_deps_after_scripts: Option<BTreeSet<String>>,

  /// If this is enabled, local packages from the workspace are preferred over packages from the registry, even if there is a newer version of the package in the registry. See more: https://pnpm.io/settings#preferworkspacepackages
  #[serde(alias = "prefer_workspace_packages")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub prefer_workspace_packages: Option<bool>,

  /// If this is enabled, pnpm creates a single pnpm-lock.yaml file in the root of the workspace. See more: https://pnpm.io/settings#sharedworkspacelockfile
  ...
  /// When executing commands recursively in a workspace, execute them on the root workspace project as well. See more: https://pnpm.io/settings#includeworkspaceroot
  #[serde(alias = "include_workspace_root")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub include_workspace_root: Option<bool>,

  /// When set to true, no workspace cycle warnings will be printed. See more: https://pnpm.io/settings#ignoreworkspacecycles
  ...
  /// When set to true, installation will fail if the workspace has cycles. See more: https://pnpm.io/settings#disallowworkspacecycles
  #[serde(alias = "disallow_workspace_cycles")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub disallow_workspace_cycles: Option<bool>,

  /// By default, pnpm deploy will try creating a dedicated lockfile from a shared lockfile for deployment. If this setting is set to true, the legacy deploy behavior will be used. See more: https://pnpm.io/settings#forcelegacydeploy
  ...
  /// If you pnpm add a package and you don't provide a specific version, then it will install the package at the version registered under the tag from this setting. See more: https://pnpm.io/settings#tag
  #[serde(skip_serializing_if = "Option::is_none")]
  ...
  /// When true, pnpm will check for updates to the installed packages and notify the user. See more: https://pnpm.io/settings#updatenotifier
  #[serde(alias = "update_notifier")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub update_notifier: Option<bool>,

  /// Create symlinks to executables in node_modules/.bin instead of command shims. This setting is ignored on Windows, where only command shims work. See more: https://pnpm.io/settings#prefersymlinkedexecutables
  #[serde(alias = "prefer_symlinked_executabled")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub prefer_symlinked_executabled: Option<bool>,

  /// During installation the dependencies of some packages are automatically patched. If you want to disable this, set this config to false. See more: https://pnpm.io/settings#ignorecompatibilitydb
  ...
  /// Set this to true if the registry that you are using returns the `time` field in the abbreviated metadata. See more: https://pnpm.io/settings#registrysupportstimefield
  #[serde(alias = "registry_supports_time_field")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub registry_supports_time_field: Option<bool>,

  /// When false, the NODE_PATH environment variable is not set in the command shims. See more: https://pnpm.io/settings#extendnodepath
  #[serde(alias = "extend_node_path")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub extend_node_path: Option<bool>,

  /// When deploying a package or installing a local package, all files of the package are copied. See more: https://pnpm.io/settings#deployallfiles
  #[serde(alias = "deploy_all_files")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub deploy_all_files: Option<bool>,

  /// When set to true, dependencies that are already symlinked to the root node_modules directory of the workspace will not be symlinked to subproject node_modules directories. See more: https://pnpm.io/settings#dedupedirectdeps
  #[serde(alias = "dedupe_direct_deps")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub dedupe_direct_deps: Option<bool>,

  /// When this setting is enabled, dependencies that are injected will be symlinked from the workspace whenever possible. See more: https://pnpm.io/settings#dedupeinjecteddeps
  #[serde(alias = "dedupe_injected_deps")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub dedupe_injected_deps: Option<bool>,

  /// When enabled, a fast check will be performed before proceeding to installation. This way a repeat install or an install on a project with everything up-to-date becomes a lot faster. See more: https://pnpm.io/settings#optimisticrepeatinstall
  #[serde(alias = "optimistic_repeat_install")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub optimistic_repeat_install: Option<bool>,

  /// Check if current branch is your publish branch, clean, and up-to-date with remote. See more: https://pnpm.io/cli/publish#configuration
  #[serde(alias = "git_checks")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub git_checks: Option<bool>,

  /// The primary branch of the repository which is used for publishing the latest changes. See more: https://pnpm.io/cli/publish#configuration
  ...
  /// The shell to use for scripts run with the pnpm run command. See more: https://pnpm.io/settings#scriptshell
  #[serde(alias = "script_shell")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub script_shell: Option<String>,

  /// When true, pnpm will use a JavaScript implementation of a bash-like shell to execute scripts. See more: https://pnpm.io/settings#shellemulator
  #[serde(alias = "shell_emulator")]
  #[serde(skip_serializing_if = "Option::is_none")]
  pub shell_emulator: Option<bool>,

  /// Saved dependencies will be configured with an exact version rather than using pnpm's default semver range operator. See more: https://pnpm.io/cli/add#--save-exact--e
